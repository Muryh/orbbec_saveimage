...
(cl:defmethod cl:initialize-instance :after ((m <point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rgb2cloud-msg:<point> is deprecated: use rgb2cloud-msg:point instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rgb2cloud-msg:x-val is deprecated.  Use rgb2cloud-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rgb2cloud-msg:y-val is deprecated.  Use rgb2cloud-msg:y instead.")
  (y m))
